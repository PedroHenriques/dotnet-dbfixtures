# Fixtures Manager Redis Driver

An abstraction layer for the [redis package](https://www.nuget.org/packages/NRedisStack) to facilitate handling database fixtures for testing purposes, in a Redis database.  
...
```sh
dotnet add [path/to/your/csproj/file] package DbFixtures.Redis
```
...
public class RedisDriverTests : IAsyncDisposable
{
  ...
  private readonly DbFixtures _dbFixtures;
  ...
  {
    await this._dbFixtures.CloseDrivers();
  }
